...
switcher.addEventListener("click", () =>{
    ...
    if (val){
        ...
        document.querySelector(".yealry").classList.add("sw-active");
    }else {
        document.querySelector(".montly").classList.add("sw-active")
...
addons.forEach((addon) => {
    addon.addEventListener("click", (e) =>{
        ...
        if (addonSelect.checked){
            ...
            addon.classList.add("add-selected");
...
function showAddon(ad, val){
    ...
    if (ad & val){
        ...
        dosument.querySelectorAll(".addons").appendChild(clone);
    }else{
